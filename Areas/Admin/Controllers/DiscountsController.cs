...
namespace JDshop.Areas.Admin.Controllers
{
    ...
    public class DiscountsController : Controller
    {
        ...
        public DiscountsController(JDshopDbContext context)
        {
            _context = context;
        }
        public async Task<IActionResult> Index()
        {
            return _context.Discounts != null ?
                        ...
                        Problem("Entity set 'JDshopDbContext.Discounts'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'JDshopDbContext.Discounts'  is null.");
            }
            var discount = await _context.Discounts.FindAsync(id);
            if (discount != null)
            {
