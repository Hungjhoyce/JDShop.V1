...
namespace JDshop.Areas.Admin.Controllers
{
    ...
    public class CollectionProductsController : Controller
    {
        ...
        public CollectionProductsController(JDshopDbContext context)
        {
            _context = context;
        }
        ...
        {
            var JDshopDbContext = _context.CollectionProducts.Include(c => c.Collection).Include(c => c.Product).ThenInclude(x => x.Images);
