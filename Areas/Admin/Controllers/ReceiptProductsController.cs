...
namespace JDshop.Areas.Admin.Controllers
{
    ...
    public class ReceiptProductsController : Controller
    {
        ...
        public ReceiptProductsController(JDshopDbContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        {
            var JDshopDbContext = _context.ReceiptProducts.Include(r => r.ProductSizeColor);
