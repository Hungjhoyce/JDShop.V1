...
public partial class JDshopDbContext : DbContext
{
    public JDshopDbContext()
    {
    }

    public JDshopDbContext(DbContextOptions<JDshopDbContext> options): base(options)
    {
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer(
            "Server=DESKTOP-B8SSS4Q;Database=JDShopDb;Trusted_Connection=True;MultipleActiveResultSets=true;TrustServerCertificate=True;");
